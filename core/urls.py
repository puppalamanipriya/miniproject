...
urlpatterns = [
    ...
    path("orders/<int:order_id>/payment/process/", views.process_payment, name="process_payment"),
    path("orders/<int:order_id>/payment/retry/", views.retry_payment, name="retry_payment"),
